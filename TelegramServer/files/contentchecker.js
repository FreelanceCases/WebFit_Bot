...
const pathfortrainings = process.env.PATH_FOR_TRAINING;
// const staticpath="/Users/velimirhlebnikov/Downloads/fff/Mishabot/Trainings/TrainingsVideos/";
// const staticpath = "/home/bot/Mishabot/Trainings/TrainingsVideos/"
// const pathfortrainings = "/home/bot/Mishabot/Trainings/All/"
// const pathfortrainings="/Users/velimirhlebnikov/Downloads/fff/Mishabot/Trainings/All";
...
async function starter(){
    ...
    Files.forEach(async (file)=>{
        ...
        if(k==false){addnewdir(mobilenumber,pathfortrainings,file)}
...
function addnewdir(mobilenumber,pathfortrainings,file){
    console.log(file)
    console.log(`Acke`)
    console.log("Fucking p "+pathfortrainings)
    console.log(mobilenumber)
    fs.mkdirSync(pathfortrainings+"/"+mobilenumber)
    console.log("Новая папка создана")
    l=pathfortrainings+"/"+mobilenumber+"/"+String(1)
    f=pathfortrainings+"/"+mobilenumber+"/"+String(0)
    fs.mkdirSync(f)
    fs.mkdirSync(l)
    remove(file,l)
...
async function metrica(adress,plus,comm){
    ...
    var videoPath = pathfortrainings+adress.toString()
